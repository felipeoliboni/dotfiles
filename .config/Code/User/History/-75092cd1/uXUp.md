...
- Mesmos HTTP, EXEC e TCP

##### Startup Probes

- Verifica se a aplicação já foi inicializada
- Garante se tudo já está funcionando

##### Boas práticas para Labels e Annotations

- `metadata` - [Doc](https://kubernetes.io/docs/concepts/overview/working-with-objects/common-labels/)
- `annotations` - [Doc](https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations/)

## Repositórios Privados

- Configurar as credenciais no manifesto
- Usar secret do docker
- Na CLI: `kubectl create secret docker-registry docker-auth --docker-server=<registry> --docker-username=<user> --docker-email=<e-mail> --docker-password=<password>`
